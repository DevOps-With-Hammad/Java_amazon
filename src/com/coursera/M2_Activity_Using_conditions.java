...
public class M2_Activity_Using_conditions {
    public static void main (String [] args){
        ...
        /**
         Solution 2.2
         This code displays which gear Toni should shift to based on different
         speeds during his trip from New York to Los Angeles.
         Try entering different values for the variable carSpeed so that you get
         all the output defined in the question.
         **/
